...
export default function ShareReceivedListTestPage() {
  ...
  const runQuick = (mode: 'basic' | 'page-1' | 'unauth') => {
    if (mode === 'basic') {
      setPage('1')
      setPerPage('10')
      return
  ...
  return (
    <div style={{ padding: 24, fontFamily: 'sans-serif' }}>
      <h1>Received Shares List Test</h1>
      <form
      ...
      >
        ...
        >
          {query.isLoading ? 'Loading...' : 'Fetch received shares'}
        </button>
      </form>
