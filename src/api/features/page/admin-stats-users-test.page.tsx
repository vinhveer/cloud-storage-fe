...
export default function AdminStatsUsersTestPage() {
  const query = useAdminUserStats()

  return (
    <div style={{ padding: 24, fontFamily: 'sans-serif' }}>
      <h1>Admin User Stats Test</h1>
      <form
        onSubmit={event => {
      ...
      >
        <p style={{ margin: 0, fontSize: 14, color: '#374151' }}>
          Endpoint: <code>/api/admin/stats/users</code>. Không yêu cầu nhập tham số.
        </p>
        <button
          type="submit"
