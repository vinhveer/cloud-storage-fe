    ...
    <div className={clsx('not-prose space-y-2', className)}>
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          onClick={() => setOn(!isOn)}
          className={clsx(
            'relative inline-flex h-6 w-11 items-center justify-center rounded-full transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2',
