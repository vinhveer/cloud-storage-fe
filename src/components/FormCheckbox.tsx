    ...
    <div className="not-prose space-y-2">
      <div className="flex items-center space-x-3">
        <input
          ...
          required={required}
          className={clsx(
            'w-5 h-5 text-blue-600 border-gray-300 dark:border-gray-600 dark:bg-gray-700 rounded focus:ring-blue-500 focus:ring-2 transition-all duration-200',
      ...
      {error ? (
        ...
        <p id={`${inputId}-help`} className="text-sm text-gray-500 dark:text-gray-400 ml-8">
          {help}
        </p>
      ) : null}
    </div>
